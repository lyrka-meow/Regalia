...
After installing or upgrading the unit, run `systemctl daemon-reload`. No unit
instance is enabled permanently: `regaliad` starts and stops the instance for
the current UID through systemd and the matching polkit rule.
